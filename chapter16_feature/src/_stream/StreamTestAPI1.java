...
import _refernce.data.EmployeeData;
...
//        distinct()——筛选，通过流所生成元素的 hashCode() 和 equals() 去除重复元素
    ...
    public void test3(){
        //sorted()——自然排序
        Integer[] arr = new Integer[]{123,3,4,5,321,4423,312,144,11,123};

        String[] arr1 = new String[]{"AA","DD","GG","GG","JJ","HH"};

...
public class ReflectTest {
    ...
    public void test1() throws Exception{
        ...
        //2. 获取或设置此属性的值
        ageFiled.set(per,2);
        System.out.println(ageFiled.get(per));
    }
...
//        System.out.println(infoField.get(Person.class));
    ...
    public void test4() throws Exception {
        ...
        Method showNField = clazz.getDeclaredMethod("showNation", String.class, int.class);
        ...
        String info = (String) showNField.invoke(per,"CHN",24);
    ...
    public void test5() throws Exception {
        ...
        //1.通过Class的实例调用getDeclaredMethod(String methodName,Class ... args),获取指定的方法
        Method showIField = clazz.getDeclaredMethod("showInfo");

        //2. setAccessible(true)：确保此方法是可访问的
        showIField.setAccessible(true);

        //3.通过Method实例调用invoke(Object obj,Object ... objs),即为对Method对应的方法的调用。
        //invoke()的返回值即为Method对应的方法的返回值
        //特别的：如果Method对应的方法的返回值类型为void，则invoke()返回值为null
        Object info = showIField.invoke(null);
        System.out.println(info);
